...
const jwt = __webpack_require__(70);
const database = __webpack_require__(5);
const adminUsers = __webpack_require__(31).adminUsers;
...
const { MongoClient } = __webpack_require__(12);
...
const exphbs  = __webpack_require__(69);

const [before, after] = __webpack_require__(36);
...
app.set('views', __dirname + '/views'); // DIRNAME NOT WORKING WITH MOCHA WEBPACK
...
const { ObjectId } = __webpack_require__(12);
const R = __webpack_require__(0);

const usersData = __webpack_require__(54);
const database = __webpack_require__(5);
...
const { MUST_BE_ADMIN, MUST_BE_LOGGED_IN } = __webpack_require__(13);
...
const keymirror = __webpack_require__(19);
const R = __webpack_require__(0);

const skill = __webpack_require__(38);
...
const skills = __webpack_require__(24);
...
const evaluation = __webpack_require__(15);
const { encrypt, decrypt } = __webpack_require__(22);
...
const mailgun = __webpack_require__(47);
const ses = __webpack_require__(48);
...
var map = {
	...
	"./evaluations.js": 52,
	"./helpers/index.js": 7,
	"./initialClientState.test.js": 55,
	"./matrices.js": 56,
	"./unit/construct-paginated-view.test.js": 57,
	"./unit/evaluation-reducer.js": 58,
	"./unit/evaluation-test.js": 59,
	"./users.js": 60,
	"./usersEvaluations.js": 61
};
...
const createHandler = __webpack_require__(16);

const actions = __webpack_require__(21);
const { getUserById } = __webpack_require__(9);
const { ONLY_USER_AND_MENTOR_CAN_SEE_ACTIONS } = __webpack_require__(13);
...
const { getEvaluationById, updateEvaluation, importEvaluation } = __webpack_require__(20);
const { templates } = __webpack_require__(17);
const { getUserById, getUserByUsername } = __webpack_require__(9);
const actions = __webpack_require__(21);

const { sendMail } = __webpack_require__(27);
...
const { templates, skills } = __webpack_require__(17);
const createHandler = __webpack_require__(16);
const { TEMPLATE_NOT_FOUND } = __webpack_require__(13);
...
const users = __webpack_require__(9);
const { templates, skills } = __webpack_require__(17);
const { newEvaluation } = __webpack_require__(15);
const evaluations = __webpack_require__(20);
const createHandler = __webpack_require__(16);
const { sendMail } = __webpack_require__(27);
const { USER_EXISTS, MUST_BE_ADMIN, USER_NOT_FOUND, TEMPLATE_NOT_FOUND, USER_HAS_NO_TEMPLATE, USER_HAS_NO_MENTOR } = __webpack_require__(13);
...
const morgan = __webpack_require__(71);
const debug = __webpack_require__(68)('skillz:http');

const { populateUser } = __webpack_require__(14);
...
const { actions } = __webpack_require__(32);
const { ensureLoggedIn } = __webpack_require__(14);
...
const authom = __webpack_require__(62);
...
const { Router } = __webpack_require__(4);
const Promise = __webpack_require__(2);
const serialize = __webpack_require__(74);
const { adminClientState, clientState } = __webpack_require__(39);
const { ensureAdmin } = __webpack_require__(14);
...
const { evaluation, evaluations } = __webpack_require__(33);
...
const users = __webpack_require__(46);
const matrices = __webpack_require__(45);
const evaluations = __webpack_require__(43);
const actions = __webpack_require__(40);
const clientApp = __webpack_require__(42);
const auth = __webpack_require__(41);
...
const { ensureAdmin } = __webpack_require__(14);
const { templates, skills } = __webpack_require__(34);
...
const { ensureAdmin } = __webpack_require__(14);
const { users, user, evaluations } = __webpack_require__(35);
...
const axios = __webpack_require__(64);
const querystring = __webpack_require__(72);
...
const AWS = __webpack_require__(63);
const Promise = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux_actions__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_keymirror__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_keymirror___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_keymirror__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constructPaginatedView__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__constructPaginatedView___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__constructPaginatedView__);
...
const getSkillsFromAppState = (appState, evaluationId) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['entities', 'evaluations', 'entities', evaluationId, 'skills'], appState);

const getFirstUnevaluatedSkill = (elements, skills) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.find(({ skillId }) => !skills[skillId].status.current)(elements);

const getNextUnevaluatedSkill = (paginatedView, skills, currentSkillId) => {
  const indexOfCurrentSkill = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.findIndex(__WEBPACK_IMPORTED_MODULE_2_ramda___default.a.propEq('skillId', currentSkillId))(paginatedView);
  const remainingPaginatedView = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.slice(indexOfCurrentSkill, Infinity, paginatedView);

  return getFirstUnevaluatedSkill(remainingPaginatedView, skills);
};

const actionTypes = __WEBPACK_IMPORTED_MODULE_1_keymirror___default()({
...
const actions = {
  init: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_actions__["createAction"])(actionTypes.SET_AS_CURRENT_EVALUATION, evaluation => evaluation),
  nextUnevaluatedSkill: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_actions__["createAction"])(actionTypes.NEXT_UNEVALUATED_SKILL, skills => skills),
  nextSkill: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_actions__["createAction"])(actionTypes.NEXT_SKILL),
  previousSkill: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_actions__["createAction"])(actionTypes.PREVIOUS_SKILL),
  nextCategory: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_actions__["createAction"])(actionTypes.NEXT_CATEGORY, skills => skills),
  previousCategory: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_actions__["createAction"])(actionTypes.PREVIOUS_CATEGORY, skills => skills),
};

function initEvaluation(evaluationId) {
  return function(dispatch, getState) {
    const evaluation = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['entities', 'evaluations', 'entities', evaluationId], getState());
...
/* harmony default export */ __webpack_exports__["default"] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux_actions__["handleActions"])({
  [actions.init]: (state, action) => {
    const evaluation = action.payload;
    const paginatedView = __WEBPACK_IMPORTED_MODULE_3__constructPaginatedView___default()(evaluation);
    const currentSkill = getFirstUnevaluatedSkill(paginatedView, evaluation.skills);
    const firstSkill = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.head(paginatedView);
    const firstCategory = firstSkill.category;
    const lastSkill = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.last(paginatedView);
  ...
  [actions.nextSkill]: (state) => {
    ...
    const indexOfCurrentSkill =  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.findIndex(__WEBPACK_IMPORTED_MODULE_2_ramda___default.a.propEq('skillId', skillId), paginatedView);
  ...
  [actions.nextUnevaluatedSkill]: (state, action) => {
    ...
    const currentSkill = getNextUnevaluatedSkill(paginatedView, skills, skillId) || __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.last(paginatedView);
  ...
  [actions.nextCategory]: (state, action) => {
    ...
    const skills = action.payload;
    const indexOfFirstElementInNextCategory = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.findLastIndex(__WEBPACK_IMPORTED_MODULE_2_ramda___default.a.propEq('category', category), paginatedView) + 1;
    const nextCategory = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['category'], paginatedView[indexOfFirstElementInNextCategory]);
    const elements = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.filter(__WEBPACK_IMPORTED_MODULE_2_ramda___default.a.propEq('category', nextCategory), paginatedView);
    const currentSkill = getFirstUnevaluatedSkill(elements, skills) || __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.last(elements);
  ...
  [actions.previousCategory]: (state, action) => {
    const { paginatedView, currentSkill: { category } } = state;
    const skills = action.payload;
    const indexOfLastElementInPrevCategory = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.findIndex(__WEBPACK_IMPORTED_MODULE_2_ramda___default.a.propEq('category', category), paginatedView) - 1;
    const prevCategory = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['category'], paginatedView[indexOfLastElementInPrevCategory]);
    const elements = __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.filter(__WEBPACK_IMPORTED_MODULE_2_ramda___default.a.propEq('category', prevCategory), paginatedView);
    const currentSkill = getFirstUnevaluatedSkill(elements, skills) || __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.last(elements);
...
const getCurrentEvaluation = (evaluation) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['evaluationId'], evaluation);
/* harmony export (immutable) */ __webpack_exports__["getCurrentEvaluation"] = getCurrentEvaluation;


const getCurrentSkill = (evaluation) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['currentSkill'], evaluation);
/* harmony export (immutable) */ __webpack_exports__["getCurrentSkill"] = getCurrentSkill;


const getFirstCategory = (evaluation) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['firstCategory'], evaluation);
/* harmony export (immutable) */ __webpack_exports__["getFirstCategory"] = getFirstCategory;


const getLastCategory = (evaluation) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['lastCategory'], evaluation);
/* harmony export (immutable) */ __webpack_exports__["getLastCategory"] = getLastCategory;


const getFirstSkill = (evaluation) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['firstSkill'], evaluation);
/* harmony export (immutable) */ __webpack_exports__["getFirstSkill"] = getFirstSkill;


const getLastSkill = (evaluation) =>
  __WEBPACK_IMPORTED_MODULE_2_ramda___default.a.path(['lastSkill'], evaluation);
/* harmony export (immutable) */ __webpack_exports__["getLastSkill"] = getLastSkill;
...
const Promise = __webpack_require__(2);
const { expect } = __webpack_require__(3);

const app = __webpack_require__(6);
const { prepopulateUsers, users, clearDb, insertAction, assignMentor } = __webpack_require__(7);
const { sign, cookieName } = __webpack_require__(1);
const actions = __webpack_require__(53);
...
const app = __webpack_require__(6);
const { prepopulateUsers, users, assignMentor, evaluations, insertTemplate, clearDb, insertSkill, insertEvaluation, getEvaluation, getAllActions } = __webpack_require__(7);
const { sign, cookieName } = __webpack_require__(1);
const { STATUS } = __webpack_require__(15);
const { NEW, SELF_EVALUATION_COMPLETE, MENTOR_REVIEW_COMPLETE } = STATUS;
const templateData = __webpack_require__(11);
const skills = __webpack_require__(10);
const [evaluation] = __webpack_require__(18);
...
const app = __webpack_require__(6);
const { prepopulateUsers, users, evaluations, insertTemplate, assignTemplate, clearDb, insertSkill, insertEvaluation, assignMentor } = __webpack_require__(7);
const { sign, cookieName } = __webpack_require__(1);
...
describe('initial client state', () => {
  ...
  describe('normal user', () => {
    it.only('returns HTML with a script tag containing initial state', () =>
      request(app)
        .get('/')
        .set('Cookie', `${cookieName}=${normalUserOneToken}`)
        .expect(200)
...
const app = __webpack_require__(6);
const { sign, cookieName } = __webpack_require__(1);
const { users, templates, skills, prepopulateUsers, insertTemplate, insertSkill, clearDb } = __webpack_require__(7);
const [sampleTemplate] = __webpack_require__(11);
const [sampleSkill] = __webpack_require__(10);
const allSkills = __webpack_require__(10);
...
const { expect } = __webpack_require__(3);
const R = __webpack_require__(0);
const constructPaginatedView = __webpack_require__(28);
...
const { expect } = __webpack_require__(3);
const reducer = __webpack_require__(49);

describe('Evaluation reducer', () => {
  it.skip('returns the initial value', () => {
...
const template = __webpack_require__(25);
const skills = __webpack_require__(24);
const fixtureEvaluations = __webpack_require__(18);
const fixtureSkills = __webpack_require__(10);
const fixtureTemplates = __webpack_require__(11);
...
const app = __webpack_require__(6);
const { prepopulateUsers, users, templates, insertTemplate, clearDb } = __webpack_require__(7);
const [sampleTemplate] = __webpack_require__(11);
const { sign, cookieName } = __webpack_require__(1);
...
const app = __webpack_require__(6);
const { prepopulateUsers, users, evaluations, insertTemplate, clearDb, insertSkill, insertEvaluation, assignMentor, getEvaluations } = __webpack_require__(7);
const { sign, cookieName } = __webpack_require__(1);
const templateData = __webpack_require__(11);
const skills = __webpack_require__(10);
const [evaluation, completedEvaluation] = __webpack_require__(18);
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    var testsContext = __webpack_require__(30);
