...
const evaluationViewModel = evaluationModel(fixtureEvaluation).adminEvaluationViewModel();
...
describe('Evaluation reducer', () => {
  describe('SET_AS_CURRENT_EVALUATION', () => {
    ...
    it('sets paginated view of skills in evaluation that are sorted by category and level', () => {
      ...
      expect(newState.paginatedView[0].skillUid).to.equal(`${fixtureEvaluation._id}_4`);
