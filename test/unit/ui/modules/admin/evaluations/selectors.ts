...
import { getSortedEvaluationsByUserId } from '../../../../../../frontend/modules/admin/evaluations';
  ...
  describe('getSortedEvaluationsByUserId', () => {
    it('returns a list of evaluations that belong to a user, from newest to oldest', () => {
      ...
      expect(getSortedEvaluationsByUserIdLenient(state, 'USER_2')).to.eql([
       { id: 'EVAL_3', createdDate: '2000-01-01T00:01:01.001Z', subject: { id: 'USER_2' } },
       { id: 'EVAL_4', createdDate: '1950-01-01T00:01:01.001Z', subject: { id: 'USER_2' } },
       { id: 'EVAL_2', createdDate: '1900-01-01T00:01:01.001Z', subject: { id: 'USER_2' } },
      ]);
    });
